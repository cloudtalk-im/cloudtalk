...
public class ImageRenderView extends BaseMsgRenderView {
    ...
    protected void onFinishInflate() {
        ...
        messageLayout = (CTMessageFrameLayout)findViewById(R.id.message_layout);
     ...
     */
    @Override
    public void render(final Message messageEntity, final User userEntity, Context ctx) {
        super.render(messageEntity, userEntity,ctx);

        if (isMine) {
            messageLayout.setBackgroundResource(R.drawable.rc_ic_bubble_no_right);

        } else {
            messageLayout.setBackgroundResource(R.drawable.rc_ic_bubble_no_left);
        }
    }
     ...
     */
    @Override
    public void msgFailure(final Message entity) {
    ...
    @Override
    public void msgStatusError(final Message entity) {
     ...
     */
    @Override
    public void msgSendinging(final Message entity) {
        if(isMine())
        {
            if(FileUtil.isFileExist(((ImageMessage)entity).getPath()))
            {
...
//                        imageProgress.hideProgress();
     ...
     */
    @Override
    public void msgSuccess(final Message entity) {
