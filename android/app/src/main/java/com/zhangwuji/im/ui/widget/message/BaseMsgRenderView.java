...
public abstract class BaseMsgRenderView extends RelativeLayout{
    ...
    public  void msgSendinging(final Message messageEntity){
        messageFailed.setVisibility(View.GONE);
        loadingProgressBar.setVisibility(View.VISIBLE);
    }

    public void msgFailure(final Message messageEntity){
        messageFailed.setVisibility(View.VISIBLE);
        loadingProgressBar.setVisibility(View.GONE);
    }

    public void msgSuccess(final Message messageEntity){
        messageFailed.setVisibility(View.GONE);
        loadingProgressBar.setVisibility(View.GONE);
    }

    public void msgStatusError(final Message messageEntity){
        messageFailed.setVisibility(View.GONE);
        loadingProgressBar.setVisibility(View.GONE);
    }

    /**控件赋值*/
    public void render(final Message entity, User userEntity, final Context ctx){
        ...
        portrait.setImageUrl(AvatarGenerate.generateAvatar(userEntity.getAvatar(),userEntity.getMainName(),userEntity.getPeerId()+""));
