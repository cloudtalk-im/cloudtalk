...
import com.zhangwuji.tools.ScreenTools;
...
import com.zhangwuji.im.ui.adapter.SearchAdapter;
...
public class SearchFragment extends TTBaseFragment {
	...
	private void searchEntityLists(String key) {
        ...
        List<Group> groupList = imService.getGroupManager().getSearchAllGroupList(key);
        int groupSize = groupList.size();
        adapter.putGroupList(groupList);

        List<Department> departmentList = imService.getContactManager().getSearchDepartList(key);
