...
public class Message implements java.io.Serializable {
    ...
    public Message(Long id, int msgId, int fromId, int toId, String sessionKey, String content, int msgType, int displayType, int status, int created, int updated) {
        this.id = id;
        this.msgId = msgId;
        this.fromId = fromId;
        this.toId = toId;
    ...
    public static String getMsgDatainfo(String content)
    {
            IMessage iMessage=null;
            try {
                iMessage=JSON.parseObject(content,IMessage.class);
            } catch (Exception e) { }
