...
public class ImageMessage extends Message implements Serializable {
    ...
    /**消息拆分的时候需要*/
    private ImageMessage(Message entity){
        /**父类的id*/
         id =  entity.getId();
    ...
    /**接受到网络包，解析成本地的数据*/
    public static ImageMessage parseFromNet(Message entity) throws JSONException {
    ...
    public static ImageMessage parseFromDB(Message entity)  {
    ...
    // 消息页面，发送图片消息
    public static ImageMessage buildForSend(ImageItem item, User fromUser, PeerEntity peerEntity){
    ...
    public static ImageMessage buildForSend(String takePhotoSavePath, User fromUser, PeerEntity peerEntity){
