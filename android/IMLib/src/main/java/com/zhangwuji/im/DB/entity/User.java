 ...
 */
public class User extends PeerEntity  {
    ...
    public User(Long id, int peerId, int gender, String mainName, String pinyinName, String realName, String avatar, String phone, String email, int departmentId, int status, int created, int updated) {
        this.id = id;
        this.peerId = peerId;
        this.gender = gender;
