...
public class AudioMessage extends Message implements Serializable{
    ...
    private AudioMessage(Message entity){
        // 父类主键
        id =  entity.getId();
    ...
    public static AudioMessage parseFromDB(Message entity)  {
    ...
    public static AudioMessage buildForSend(float audioLen, String audioSavePath, User fromUser, PeerEntity peerEntity){
