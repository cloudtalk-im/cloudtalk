...
public class RecentInfo {
    ...
    public RecentInfo(){}
    public RecentInfo(Session sessionEntity, User entity, UnreadEntity unreadEntity){
        ...
        latestMsgData= Message.getMsgDatainfo(latestMsgData);
    ...
    public RecentInfo(Session sessionEntity, Group groupEntity, UnreadEntity unreadEntity){
        sessionKey =  sessionEntity.getSessionKey();
        peerId = sessionEntity.getPeerId();
        ...
        if(groupEntity !=null) {
            ...
            for(Integer userId:list){
                User entity = IMContactManager.instance().findContact(userId);
                if(entity!=null){
                    String s= AvatarGenerate.generateAvatar(entity.getAvatar(),entity.getMainName(),entity.getPeerId()+"");
                    avatarList.add(s);
                }
