...
public interface DBConstant {
    ...
    public final int  MSG_TYPE_SYSTEM = 136;
    public final int  MSG_TYPE_NOTICE_FRIEND = 137;
    public final int  MSG_TYPE_NOTICE_SYSTEM = 138;
    ...
    public final int SESSION_TYPE_SYSTEM= 3;
    public final int SESSION_TYPE_NOTICE= 4;
    public final int SESSION_TYPE_CHATROOM= 5;
